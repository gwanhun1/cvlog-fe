  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50/50 via-white to-white">
      <Head>
        ...
        />
        <meta name="keywords" content="마크다운, 블로그, 개발자, 프로그래밍, 기술 블로그, LOGME" />
        <meta property="og:title" content="LOGME - 개발자를 위한 마크다운 블로그" />
        <meta property="og:description" content="개발자를 위한 궁극의 마크다운 블로그 플랫폼" />
        ...
        <meta name="twitter:title" content="LOGME - 개발자를 위한 마크다운 블로그" />
