  ...
  return <main className="mx-auto max-w-6xl px-5 py-10 tablet:py-16">
    ...
    <section className="pb-12" aria-labelledby="feature-demo-title">
      <div className="mb-6">
        ...
        <h2 id="feature-demo-title" className="mt-2 text-2xl font-bold text-slate-900">글쓰기 기능을 움직이는 화면으로 확인하세요</h2>
        <p className="mt-3 max-w-2xl leading-7 text-slate-600">마크다운 작성부터 이미지 업로드, 글 탐색과 태그 정리까지 실제 동작을 탭별로 볼 수 있습니다.</p>
      </div>
