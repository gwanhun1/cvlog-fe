    ...
    <article className="min-w-0 desktop:only:col-span-2">
      {imageUrl && !imageFailed && (
        <Link
          ...
          className="group/media relative mb-4 block aspect-[16/8] overflow-hidden rounded-[14px] bg-slate-100 focus-visible:ring-2 focus-visible:ring-ftBlue focus-visible:ring-offset-2 desktop:aspect-[16/6.4]"
